...
public class SHA1Util {
	...
	public static synchronized SHA1Util getInstance() {
		if (instance == null) {
	...
	public static void main(String[] args) {
		...
		System.out.println(SHA1Util.getInstance().Digest("我们", "UTF-8"));
		// 24E384109C1FE06E363DB1FF6C8F8DDBF18C45EA
		System.out.println(SHA1Util.getInstance().Digest("我们"));
